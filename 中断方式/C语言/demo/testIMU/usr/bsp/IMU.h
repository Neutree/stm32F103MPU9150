...
//----------------MS561101BA-----------------------------------------------------------
#define MS561101BA_ADDR 0xEE   //addresses of MS561101BA 0xEE,CBR=0 ,  0xEC, CBR=1
...
/////////////////////////////////
///开始执行队列里的命令
///@attention 一定要在IMU_Is_Device_Ready()==I2C_True并且IMU_Is_Queue_Empty()==I2C_False时才能执行
////////////////////////////////
