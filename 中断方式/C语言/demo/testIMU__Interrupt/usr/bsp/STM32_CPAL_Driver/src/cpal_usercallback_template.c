...
void CPAL_I2C_ERR_UserCallback(CPAL_DevTypeDef pDevInstance, uint32_t DeviceError)
{
	if (pDevInstance == CPAL_I2C1)
	{
		switch(DeviceError)
		{
			case CPAL_I2C_ERR_NONE:
				break;
			case CPAL_I2C_ERR_TIMEOUT:
				printf("\nerror call back time out\n");
				break;
			case CPAL_I2C_ERR_BERR:
				break;
			case CPAL_I2C_ERR_ARLO:
				break;
			case CPAL_I2C_ERR_AF://no ack
				printf("\nno ack\n");
				break;
			case CPAL_I2C_ERR_OVR:
				break;		
		}
		printf("\n\nError\n\n");
